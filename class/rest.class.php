<?
    class rest{
        ...
        public static function init($restrict=true){
            ...
            unset(rest::$params['module']);
            unset(rest::$params['action']);
        ...
        public static function checkReferer(){
            ...
            $request = str_replace('/rest/', '/', substr($request, 0, strrpos($request, '/')));
            if(APP === "backend" && $request !== $referer){
        ...
        public static function render($result=true, $data=''){
            self::renderJson(
                array(
                    "success" => $result, 
                    'data' => $data
